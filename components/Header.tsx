    ...
    <header className="fixed w-full bg-white z-50">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          {['accueil', 'services', 'destinations', 'about', 'contact'].map((section) => (
            <a key={section} href={`#${section}`} className="nav-link text-dark font-medium hover:text-primary transition-colors capitalize">
      ...
      >
        ...
        <div className="flex flex-col px-4 py-2">
          ...
          <a
            href="#contact"
            className="mt-4 bg-gradient-to-r from-gold to-primary text-white px-6 py-2 rounded-button font-medium hover:opacity-90 transition-opacity text-center"
          >
            Nous Contacter
          </a>
        </div>
